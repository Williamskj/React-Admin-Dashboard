...
const FAQ = () => {
    ...
    return <Box m="20px">
        ...
        <Accordion defaultExpanded>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography color={colors.greenAccent[500]} variant="h5">
                    Is all the code that allows this site to function following
                    industry practices?
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
                <Typography>
                    Yes. All the code that runs this site is all up-to-date
                    and industry standard as of Early March 2023.
                </Typography>
            </AccordionDetails>
        </Accordion>
        <Accordion defaultExpanded>
            ...
            <AccordionDetails>
                <Typography>
                    This site uses React, Material UI, Nivo Charts, Formik, Fullcalendar,
                     Data Grid and Yup.
                </Typography>
            </AccordionDetails>
        </Accordion>
        <Accordion defaultExpanded>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography color={colors.greenAccent[500]} variant="h5">
                    Why do you use an Image of Mark Zuckerburg for your example
                    profile image?
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
